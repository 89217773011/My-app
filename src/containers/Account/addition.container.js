  ...
  render() {
    return (
      <Segment inverted>
        ...
        <Form
          className="segment"
          onSubmit={this.handleSubmitAdditionForm}
        ...
        >
          ...
          <Form.Field>
            <label>Trainer</label>
            <select placeholder="Trainer" onChange={this.handleTrainer}>
              {TRAINING.map((training, i) => (
                <option key={i}>{training}</option>
              ))}
            </select>
          </Form.Field>
          <Form.Field>
          ...
          <Form.Field>
            <label>Towel</label>
            <input type="checkbox" value="towel" onChange={this.handleTowel} />
          </Form.Field>
          <Form.Field>
        ...
        <p className="addition_form">
          You can see your current trainings{" "}
          <Link to="/currenttrainings">here</Link>
        </p>
      </Segment>
    );
  }
